...
func TestPackageStagingLayoutAndModes(t *testing.T) {
	...
	expected := map[string]os.FileMode{
		...
		"usr/share/doc/lts-agent/examples/lbi/lbi-unprivileged-checks.sh": 0o644,
		"usr/share/doc/lts-agent/examples/lbi/lbi-validate.sh":            0o644,
		"usr/share/doc/lts-agent/examples/lbi/health-check.sh":            0o644,
	}
